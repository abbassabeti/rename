...
final argParser = ArgParser()
  ...
  ..addOption(facebookId, abbr: 'i', help: 'Sets the facebook id on ios.')
  ..addOption(clientToken, abbr: 'c', help: 'Sets the facebook client token on ios.')
  ..addOption(facebookIdKey, abbr: 'k', help: 'Sets the facebook id key on android.')
  ..addOption(protocolSchemeKey, abbr: 's', help: 'Sets the facebook protocol scheme key on android.')
